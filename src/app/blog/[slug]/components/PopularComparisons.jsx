...
export default function PopularComparisons({ comparisons }) {
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 space-y-1 text-xs text-muted">
                    <p>{formatPrice(car1.startingPrice, car1.endingPrice)}</p>
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 space-y-1 text-xs text-muted">
                    <p>{formatPrice(car2.startingPrice, car2.endingPrice)}</p>
