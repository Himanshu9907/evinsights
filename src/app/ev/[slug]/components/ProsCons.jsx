    ...
    <section id="proscons" className="mt-14">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted">
          Every EV has strengths and compromises. Here's a quick overview of
          what makes{" "}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-green-500/20 bg-card p-6 shadow-theme">
          <div className="mb-6 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-green-500/10">
              <CheckCircle2
                size={22}
        ...
        <div className="rounded-2xl border border-red-500/20 bg-card p-6 shadow-theme">
          <div className="mb-6 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-red-500/10">
              <XCircle
                size={22}
